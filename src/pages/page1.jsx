...
export const Page1 = () => {
  return (
    <>
       <section className="bg-cover bg-no-repeat h-screen bg-center
        w-full"
      ...
      <nav className='flex bg-amber-200 w-1/2 justify-center mx-auto'>
        <ul className='flex p-4 mx-4'>
          ...
          <li className='m-3 cursor-pointer hover:text-lime-600'>Pages</li>
      ...
      <h2 className='text-3xl mt-64 p-4 w-60 text-lime-400 '>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Similique, quae.</h2>
